...
import { Search, GitFork, Star, Clock, Github } from "lucide-react";
                ...
                <CardHeader>
                  <CardTitle className="text-xl flex items-center  gap-2 flex-wrap">
                    ...
                    {plugin.isOfficial && (
                      <Badge
                        variant="secondary"
                        className="bg-blue-100 text-blue-800 dark:bg-blue-100"
                      >
                        Official
                      </Badge>
                    )}
                  ...
                  <div className="text-sm text-gray-500 flex items-center gap-2">
                    ...
                    {plugin.payloadVersionMajor && (
                      <Badge
                        variant="outline"
                        className="gap-1"
                        title={plugin.payloadVersion!}
                      >
                        <PayloadIcon className="h-3 w-3  " />
                        Payload version{" "}
                        {plugin.payloadVersionMajor.map((v) => v).join(" & ")}
                      </Badge>
                    )}
                  </div>
                </CardHeader>
